...
void unionSets(int a, int b) {
    ...
    if (rep1 == NULL || rep2 == NULL) {
        printf("The elements are not present in the disjoint set\n");
        return;
    }
...
int main() {
    ...
    printf("Enter the size of the set between 1 to 20: ");
    scanf("%d", &setSize);

    while (setSize <= 0 || setSize > 20) {
        printf("Invalid set size. Please enter a size between 1 and 20: ");
        scanf("%d", &setSize);
    }
    ...
    do {
	   ...
	   default:
		printf("Invalid Choice!!!Please Enter choices from 1 to 5...");
		}
